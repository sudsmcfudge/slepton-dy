...
void makeTree(vector<TString> fn)
{
  ...
  Double_t opAngle,m,deltaPhi,deltaEta,deltaR;
  ...
  for (Long64_t iev=0; iev<nEvents; iev++){
	...
	opAngle = TMath::Abs(deltaPhi);
      ...
      // deltaR check elecs and jets
      
      //      for (i=0; i<nelec; i++){
      //	for (j=0; j<njets; j++){
      //	  elec1 = (TRootElectron *) branchElec->At(i);
      //	  jet1 = (TRootJet *) branchJets->At(j);

      //	  deltaPhi = elec1->Phi - jet1->Phi;
      //	  deltaEta = elec1->Eta - jet1->Eta;
